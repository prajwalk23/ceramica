...
router.get("/checkout", middleware.isLoggedIn, async (req, res) => {
  ...
  try {
    ...
    const order = new Order({
      ...
      address: req.body.address || 'Default Address', // Assuming address is provided or a default value is used
      paymentId: null, // Since we're not processing payment, this can be null or a placeholder
    });

    await order.save();

    // Delete the cart and clear the session cart
